	...
	public boolean action(L2PcInstance activeChar, L2Object target, boolean interact) {
		...
		if (activeChar.getAccessLevel().isGm()) {
			...
			if (((L2Npc) target).hasAI()) {
				...
				html.replace("%ai_enemy_clan%", "<tr><td><table width=270 border=0 bgcolor=131210><tr><td width=100><font color=FFAA00>Ignore & Range:</font></td><td align=right width=170>" + ignoreClanNpcIdsString + " " + ((L2Npc) target).getTemplate().getAggroRange()
					+ "</td></tr></table></td></tr>");
			} else {
