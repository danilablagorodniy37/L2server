...
public class OlympiadManagerLink implements IBypassHandler {
	...
	private static final String FEWER_THAN = "Fewer than " + olympiad().getRegistrationDisplayNumber();
	private static final String MORE_THAN = "More than " + olympiad().getRegistrationDisplayNumber();
