...
public final class TullyWorkshop extends AbstractNpcAI {
	...
	private static List<L2Npc> postMortemSpawn = new ArrayList<>();
	private static Set<Integer> brokenContraptions = ConcurrentHashMap.newKeySet();
	private static Set<Integer> rewardedContraptions = new HashSet<>();
	private static Set<Integer> talkedContraptions = new HashSet<>();
