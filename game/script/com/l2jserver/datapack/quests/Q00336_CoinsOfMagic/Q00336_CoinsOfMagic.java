...
public final class Q00336_CoinsOfMagic extends Quest {
	...
	private String shortFirstSteps(QuestState qs, int npcId, int weightPoint, int base, int ITEM_1_1, int ITEM_1_2, int ITEM_1_MUL, int ITEM_2, int ITEM_3, int ITEM_4) {
		switch (qs.getInt(PARAM_2)) {
			case 42: {
				if ((qs.getQuestItemsCount(ITEM_1_1) >= ((long) base * ITEM_1_MUL)) && ((ITEM_1_2 == 0) || (qs.getQuestItemsCount(ITEM_1_2) >= base))) {
					qs.set(FLAG, 1);
					qs.takeItems(ITEM_1_1, (long) base * ITEM_1_MUL);
					if (ITEM_1_2 > 0) {
	...
	private String shortSecondStepOneItem(QuestState qs, int npcId, int mul, int ITEM_1, int ITEM_1_MUL, int REWARD_1, int ITEM_2, int REWARD_2, int ITEM_3, int REWARD_3, int ITEM_4, int REWARD_4) {
		switch (qs.getInt(PARAM_2)) {
			case 42: {
				if ((qs.getQuestItemsCount(ITEM_1) >= (10L * mul * ITEM_1_MUL))) {
					qs.takeItems(ITEM_1, 10L * mul * ITEM_1_MUL);
					qs.giveItems(REWARD_1, mul);
					qs.playSound(Sound.ITEMSOUND_QUEST_MIDDLE);
			...
			case 31: {
				if (qs.getQuestItemsCount(ITEM_2) >= (5L * mul)) {
					qs.takeItems(ITEM_2, 5L * mul);
					qs.giveItems(REWARD_2, mul);
					qs.playSound(Sound.ITEMSOUND_QUEST_MIDDLE);
					return npcId + "-07.html";
				}
				break;
			...
			case 21: {
				if (qs.getQuestItemsCount(ITEM_3) >= (5L * mul)) {
					qs.takeItems(ITEM_3, 5L * mul);
					qs.giveItems(REWARD_3, mul);
					qs.playSound(Sound.ITEMSOUND_QUEST_MIDDLE);
					return npcId + "-07.html";
				}
				break;
			...
			case 11: {
				if (qs.getQuestItemsCount(ITEM_4) >= (5L * mul)) {
					qs.takeItems(ITEM_4, 5L * mul);
					qs.giveItems(REWARD_4, mul);
					qs.playSound(Sound.ITEMSOUND_QUEST_MIDDLE);
					return npcId + "-07.html";
				}
				break;
	...
	private String shortSecondStepTwoItems(QuestState qs, int npcId, int mul, int ITEM_1_1, int ITEM_1_2, int REWARD_1, int ITEM_2_1, int ITEM_2_2, int REWARD_2, int ITEM_3_1, int ITEM_3_2, int REWARD_3, int ITEM_4_1, int ITEM_4_2, int REWARD_4) {
		switch (qs.getInt(PARAM_2)) {
			case 42: {
				if ((qs.getQuestItemsCount(ITEM_1_1) >= (10L * mul)) && (qs.getQuestItemsCount(ITEM_1_2) >= (10L * mul))) {
					qs.takeItems(ITEM_1_1, 10L * mul);
					qs.takeItems(ITEM_1_2, 10L * mul);
					qs.giveItems(REWARD_1, mul);
					qs.playSound(Sound.ITEMSOUND_QUEST_MIDDLE);
					return npcId + "-07.html";
				}
			...
			case 31: {
				if ((qs.getQuestItemsCount(ITEM_2_1) >= (5L * mul)) && (qs.getQuestItemsCount(ITEM_2_2) >= (5L * mul))) {
					qs.takeItems(ITEM_2_1, 5L * mul);
					qs.takeItems(ITEM_2_2, 5L * mul);
					qs.giveItems(REWARD_2, mul);
					qs.playSound(Sound.ITEMSOUND_QUEST_MIDDLE);
					return npcId + "-07.html";
				}
			...
			case 21: {
				if ((qs.getQuestItemsCount(ITEM_3_1) >= (5L * mul)) && (qs.getQuestItemsCount(ITEM_3_2) >= (5L * mul))) {
					qs.takeItems(ITEM_3_1, 5L * mul);
					qs.takeItems(ITEM_3_2, 5L * mul);
					qs.giveItems(REWARD_3, mul);
					qs.playSound(Sound.ITEMSOUND_QUEST_MIDDLE);
					return npcId + "-07.html";
				}
			...
			case 11: {
				if ((qs.getQuestItemsCount(ITEM_4_1) >= (5L * mul)) && (qs.getQuestItemsCount(ITEM_4_2) >= (5L * mul))) {
					qs.takeItems(ITEM_4_1, 5L * mul);
					qs.takeItems(ITEM_4_2, 5L * mul);
					qs.giveItems(REWARD_4, mul);
					qs.playSound(Sound.ITEMSOUND_QUEST_MIDDLE);
					return npcId + "-07.html";
				}
