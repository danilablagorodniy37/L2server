...
public final class Q00257_TheGuardIsBusy extends Quest {
	...
	static {
		...
		MONSTERS.put(20093, List.of(new MobDrop(100, 85, ORC_NECKLACE, 1))); // Orc Fighter
		MONSTERS.put(20096, List.of(new MobDrop(100, 95, ORC_NECKLACE, 1))); // Orc Fighter Sub Leader
		MONSTERS.put(20098, List.of(new MobDrop(100, 100, ORC_NECKLACE, 1)));// Orc Fighter Leader
		MONSTERS.put(20130, List.of(new MobDrop(10, 7, ORC_AMULET, 1))); // Orc
		MONSTERS.put(20131, List.of(new MobDrop(10, 9, ORC_AMULET, 1))); // Orc Grunt
		MONSTERS.put(20132, List.of(new MobDrop(10, 7, WEREWOLF_FANG, 1))); // Werewolf
		MONSTERS.put(20342, List.of(new MobDrop(0, 1, WEREWOLF_FANG, 1))); // Werewolf Chieftain
		MONSTERS.put(20343, List.of(new MobDrop(100, 85, WEREWOLF_FANG, 1))); // Werewolf Hunter
	}
