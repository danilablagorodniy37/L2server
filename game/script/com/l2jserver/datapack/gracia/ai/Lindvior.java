...
public class Lindvior extends AbstractNpcAI {
	...
	private static final int LINDVIOR_SCENE_ID = 1;
	...
	private static final boolean ALT_MODE = false;
	private static final int ALT_MODE_MIN = 60; // schedule delay in minutes if ALT_MODE enabled
	...
	public void scheduleNextLindviorVisit() {
		long delay = (ALT_MODE) ? ALT_MODE_MIN * 60000L : scheduleNextLindviorDate();
