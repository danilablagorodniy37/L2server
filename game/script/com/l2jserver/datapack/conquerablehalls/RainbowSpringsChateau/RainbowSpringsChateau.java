...
public final class RainbowSpringsChateau extends ClanHallSiegeEngine {
	...
	private static final L2Spawn[] _gourds = new L2Spawn[4];
	...
	private static List<L2Clan> _acceptedClans = new ArrayList<>(4);
	private static final Map<String, ArrayList<L2Clan>> _usedTextPassages = new HashMap<>();
	private static final Map<L2Clan, Integer> _pendingItemToGet = new HashMap<>();
