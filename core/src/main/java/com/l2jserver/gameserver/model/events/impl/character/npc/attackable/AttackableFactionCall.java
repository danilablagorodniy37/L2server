...
/**
 * Attackable Faction Call event.
 * @author UnAfraid
 * @author Zoey76
 */
public record AttackableFactionCall(L2Npc npc, L2Npc caller, L2PcInstance attacker, boolean isSummon) implements BaseEvent {
	@Override
	public EventType getType() {
		return ATTACKABLE_FACTION_CALL;
	}
}
