...
- [ ] Квесты 234 (Fate's Whisper) и 503 (Pursuit of Clan Ambition) в H5 переделаны вокруг новых предметов (White Cloth, Spiteful Soul) — перенести версии aCis, пока в `checks.KNOWN`
